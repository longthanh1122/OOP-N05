...
import com.mycompany.parkingmanagement.entity.ParkingTicket;
...
public class ManagerView extends javax.swing.JFrame {
        ...
        panelChartLayout.setHorizontalGroup(
            ...
            .addGroup(panelChartLayout.createSequentialGroup()
                ...
                .addGroup(panelChartLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(ScrollPaneStatistic, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
     ...
     * @param list
     */
    public void showListSpecialPersons(List<ParkingTicket> list) {
        int size = list.size();
    ...
    public void showCountListSpecialPersons(List<ParkingTicket> list) {
        int size = list.size();
     ...
     * @param specialPerson
     */
    public void showSpecialPerson(ParkingTicket specialPerson) 
    {
    ...
    public void showStatisticTypeSpecialPersons(List<ParkingTicket> list) {
    ...
    public void showStatisticAgeSpecialPersons(List<ParkingTicket> list) {
