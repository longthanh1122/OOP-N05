...
public class VehicleController {
    ...
    public VehicleController(ParkingView view) {
        this(view);
    }
    ...
    VehicleController(com.mycompany.parkingmanagement.view.VehicleView vehicleView) {
    ...
    class AddVehicleListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            if (vehicle != null) {
                if (!vehicleManager.isLicensePlateUnique(vehicle.getLicensePlate())) {
                    parkingView.showMessage("Biển số đã tồn tại!");
                    return;
                }
